...
public class ADropAmmo implements TabCompletion{
    ...
    public boolean onCommand(UPlayer p, String weapon, int ammo) {
        if (!weapon.equalsIgnoreCase("M4") && !weapon.equalsIgnoreCase("MP5") && !weapon.equalsIgnoreCase("Jagdlinte") && !weapon.equalsIgnoreCase("Pistole")) return false;
    ...
    public List<String> getTabCompletions(UPlayer p, String[] args) {
        return Arrays.asList("M4", "MP5", "Jagdflinte", "Pistole");
    }
