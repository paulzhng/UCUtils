...
public enum Faction {
    UCPD("polizei", "Police", constructFactionInfo("UnicaCity Police Department", "UCPD",
    ...
    FBI("fbi", "FBI", constructFactionInfo("Federal Bureau of Investigation", "FBI",
    ...
    UCMD("rettungsdienst", "Medic", constructFactionInfo("Rettungsdienst", "UCMD",
    ...
    NEWS("news", "News", constructFactionInfo("News Agency", "News",
    ...
    TERRORISTS("terroristen", "Terroristen", constructFactionInfo("Terroristen", "Terroristen",
    ...
    HITMAN("hitman", "Hitman", constructFactionInfo("Hitman", "Hitman",
    ...
    CHURCH("kirche", "Church", constructFactionInfo("Kirche", "Kirche",
    ...
    LA_COSA_NOSTRA("lacosanostra", "Mafia", constructBadFactionInfo("La Cosa Nostra", "Cosa Nostra",
    ...
    CALDERON("calderon", "Mexican", constructBadFactionInfo("Calderón Kartell", "Calderón",
    ...
    JUGGALOS("juggalos", "Gang", constructBadFactionInfo("Juggalos", "Juggalos",
    ...
    KERZAKOV("kerzakov", "Kerzakov", constructBadFactionInfo("Kerzakov Familie", "Kerzakov",
    ...
    TRIADS("triaden", "Triaden", constructBadFactionInfo("Triaden", "Triaden",
    ...
    OBRIEN("o_brien", "O_Brien", constructBadFactionInfo("O'Brien Familie", "O'Brien",
    ...
    Faction(String apiName, String factionKey, FactionInfo factionInfo, int publicChannelID) {
