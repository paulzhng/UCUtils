...
public class ToggleKerzakovSpeechCommand implements CommandExecutor {

    private static boolean activated;
    private static final SpeechModifier MODIFIER = new KerzakovSpeechModifier();
    ...
    public boolean onCommand(EntityPlayerSP p, String[] args) {
        ...
        ITextComponent text = activated
                ? TextUtils.simpleMessage("Du hast die Kerzakovsprache eingeschalten.", TextFormatting.GREEN)
                : TextUtils.simpleMessage("Du hast die Kerzakovsprache ausgeschalten.", TextFormatting.RED);
